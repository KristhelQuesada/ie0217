...
## Ejecucion
Ahora bien, para la ejecucion del programa asumiendo que la posicion en el directorio es __../Laboratorios/Laboratorio2/__ entonces ejecutese:
```
>>> g++ -o ejecutable.exe ./main.cpp ./Empleado.cpp ./EmpleadoAsalariado.cpp ./EmpleadoPorHoras.cpp
>>> ./ejecutable.exe
```

## Resumen Teorico
Este laboratorio tiene como objetivo desarrollar temas relacionadas a la programacion orientada a objetos de tal forma que se repasaron conceptos como sus 4 pilares, entre ellos:
